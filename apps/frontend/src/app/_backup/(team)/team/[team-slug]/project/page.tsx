...
import { ProjectTable } from '@/components/pages/project/project.tabe';
  ...
  return (
    <>
      <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <Button
                ...
                className={
                  isCreateDialogOpen
                    ? 'border-b-2 border-b-main text-white'
                    : 'border-b-2 border-b-main hover:bg-main-300 text-white'
                }
              >
        ...
        {isCreateDialogOpen && (
          <div className="bg-section border-2 border-main p-6 shadow-lg animate-in fade-in slide-in-from-top-4 duration-300">
            <CreateProject
              teamSlug={teamSlug}

...
export default function UpdateAvatar({
  ...
  const handleSubmitAvatar = () => {
    ...
    updateAvatar(
      { avatarUrl: mediaUrl },
      {
        ...
        onError: (error) => {
          onUploadError?.(error.message || 'Failed to update avatar');
        },
      }
    );
  };
  ...
  return (
    <Card className="w-64 h-64 max-w-md mx-auto">
      <CardContent className="p-6">
        {status === 'idle' && (
          <div
            className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-main-600 transition-colors"
            onDrop={handleDrop}
            ...
            <div className="w-16 h-16 mx-auto mb-4 relative">
              ...
              >
                ...
                <circle
                  ...
                  r="16"
                  fill="none"
                  className="stroke-current text-main-600"
                  strokeWidth="3"
                  strokeDasharray="100"
              ...
              <FileIcon className="w-8 h-8 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-main-600" />
            </div>
        ...
        {status === 'preview' && file && (
          <div className="text-center">
            {previewUrl && (
              <div className="w-32 h-32 mx-auto mb-4 rounded-md overflow-hidden">
                <img
                  src={previewUrl}
                  alt="Preview"
            ...
            <div className="flex gap-2 justify-center">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-main-600 hover:bg-main-700 disabled:bg-gray-400 rounded-lg transition-colors"
              >
                Upload
              </button>
              <button
          ...
          <div className="text-center">
            ...
            <div className="flex gap-2 justify-center">
              ...
              <button
                onClick={resetUpload}
                disabled={isUpdatingAvatar}
                className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-700 border border-gray-200 hover:border-gray-300 rounded-lg transition-colors"
              >
                Cancel
              </button>
            </div>

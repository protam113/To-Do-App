...
//   CardTitle,
// } from '@/components/ui';
// import { TeamProjectResponse } from '@/types';
...
// export const ProjectCard = ({ project, teamSlug }: ProjectCardProps) => {
//   return (
//     <Link
//       href={`/admin/team/${teamSlug}/project/${project.slug}`}
...
//           <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.05)_1px,transparent_1px)] bg-[length:4px_4px]" />
//         </div>

//         <CardHeader className="relative p-4 pb-2">
//           <CardTitle className="text-lg font-semibold text-gray-80 ">
//             {project.name}
//           </CardTitle>
//         </CardHeader>

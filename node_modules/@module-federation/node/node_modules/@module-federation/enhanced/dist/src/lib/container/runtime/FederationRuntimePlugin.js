...
function isEsmOutputBuild(compiler) {
...
function getModuleCandidates(packageName, preferEsm) {
...
function resolveRuntimePaths(preferEsm, implementation) {
    const runtimeToolsCandidates = getModuleCandidates('@module-federation/runtime-tools', preferEsm);
    const bundlerRuntimeCandidates = getModuleCandidates('@module-federation/webpack-bundler-runtime', preferEsm);
    const runtimeCandidates = getModuleCandidates('@module-federation/runtime', preferEsm);
...
const { runtimeToolsPath: RuntimeToolsPath, bundlerRuntimePath: BundlerRuntimePath, runtimePath: RuntimePath, } = resolveRuntimePaths(true);
